...
const DEFAULT_BOOKMARKS = [
    ...
    { title: '📰 Новости & Инфо', links: [{ name: 'ТАСС', url: 'https://tass.ru/' }, { name: 'Дзен', url: 'https://dzen.ru' }, { name: 'Хабр', url: 'https://habr.com/' }, { name: '4PDA', url: 'https://4pda.to/' }, { name: 'iXBT', url: 'https://www.ixbt.com/' }] },
